# rust-syntax-tools-rustrover-plugin
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "rust-syntax-tools-rustrover-plugin"</kbd> >
  <kbd>Install</kbd>
